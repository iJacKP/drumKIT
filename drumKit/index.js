...
document.querySelectorAll(".drum")[i].addEventListener("click", function() {
        ...
        var buttonInnerHMTL = this.innerText;
...
function buttonAnimation(currentKey) {
 ...
 //JUST TESTING CONSTRUCTOR FUNCTIONS

// function FrenchMaid (name,age,ageOfExperience,isMarriage,haveKids) {
//         this.name=name;
//         this.age=age;
...
//         this.bitch= function(){
//                 alert("I'm cleaning the house,bitch!");

//         }
//       }

// Define a new FrenchMaid() with the parameters and give it a go ! (consolo.log())